...
${PR_PRINCIPAL}${PR_ULCORNER}${PR_HBAR}${PR_GREY}(\
${PR_SECOND}%${PR_PWDLEN}<...<%~%<<\
${PR_GREY})$(ruby_prompt_info)%{$FG[009]%}${PR_HBAR}${PR_HBAR}${(e)PR_FILLBAR}${PR_HBAR}${PR_GREY}(\
${PR_CYAN}%(!.%SROOT%s.%n)${PR_GREY}@${PR_SECOND}%m:%l\
${PR_GREY})%{$FG[009]%}${PR_HBAR}${PR_URCORNER}\

${PR_PRINCIPAL}${PR_LLCORNER}${PR_PRINCIPAL}${PR_HBAR}(\
${PR_THIRD}%D{%H:%M:%S}\
${PR_PRINCIPAL}%{$reset_color%}$(git_prompt_info)$(git_prompt_status)${PR_PRINCIPAL})${PR_HBAR}\
${PR_HBAR}\
>${PR_NO_COLOUR} '
...
${PR_PRINCIPAL}${PR_HBAR}${PR_NO_COLOUR} '
